...
zcat data_31_01_20/All_ind_beagle.GATK_no_dam.gz | cut -f 1-3,4-33,37-66,271-342 | bgzip -i -I tmp/Can_ind.GATK_no_dam.beagle.gz.gzi -c >tmp/Can_ind.GATK_no_dam.beagle.gz # GATK SNPs filtered for no aDNA damage
