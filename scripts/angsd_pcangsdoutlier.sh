...
# Canada (n = 21 and 24, individuals #1-21 and #90-113 (see data_31_01_20/List_to_malin.tab)
#zcat data_31_01_20/All_ind.beagle.gz | cut -f 1-3,4-66,271-342 | bgzip -i -I tmp/Can_ind.beagle.gz.gzi -c >data_31_01_20/tmp.beagle.gz # all SNPs
zcat data_31_01_20/All_ind_beagle.GATK.gz | cut -f 1-3,4-66,271-342 | bgzip -i -I tmp/Can_ind.GATK.beagle.gz.gzi -c >tmp/Can_ind.GATK.beagle.gz # GATK SNPs

zcat data_31_01_20/All_ind_beagle.GATK_no_dam.gz | cut -f 1-3,4-66,271-342 | bgzip -i -I tmp/Can_ind.GATK_no_dam.beagle.gz.gzi -c >tmp/Can_ind.GATK_no_dam.beagle.gz # GATK SNPs filtered for no aDNA damage

zcat data_31_01_20/All_ind_beagle.GATK_ex_inv.gz | cut -f 1-3,4-66,271-342 | bgzip -i -I tmp/Can_ind.GATK_ex_inv.beagle.gz.gzi -c >tmp/Can_ind.GATK_ex_inv.beagle.gz # GATK SNPs w/out inversions
...
zcat data_31_01_20/All_ind_beagle.GATK_no_dam.gz | cut -f 1-3,67-132,133-204 | bgzip -i -I tmp/Lof0711_ind.GATK_no_dam.beagle.gz.gzi -c >tmp/Lof0711_ind.GATK_no_dam.beagle.gz
...
zcat data_31_01_20/All_ind_beagle.GATK_no_dam.gz | cut -f 1-3,67-132,205-270 | bgzip -i -I tmp/Lof0714_ind.GATK_no_dam.beagle.gz.gzi -c >tmp/Lof0714_ind.GATK_no_dam.beagle.gz
...
zcat data_31_01_20/All_ind_beagle.GATK_no_dam.gz | cut -f 1-3,133-204,205-270 | bgzip -i -I tmp/Lof1114_ind.GATK_no_dam.beagle.gz.gzi -c >tmp/Lof1114_ind.GATK_no_dam.beagle.gz
...
###########################################
# Trim to unlinked loci (only GATK loci)
###########################################
...
zcat tmp/Can_ind.GATK_no_dam.beagle.gz | java -jar scripts/filterlines.jar 1 tmp/Can.gatk.unlink.beagle.pos | bgzip -i -I tmp/Can_ind.GATK_no_dam.unlink.beagle.gz.gzi >tmp/Can_ind.GATK_no_dam.unlink.beagle.gz
...
zcat tmp/Lof0711_ind.GATK_no_dam.beagle.gz | java -jar scripts/filterlines.jar 1 tmp/Lof.gatk.unlink.beagle.pos | bgzip -i -I tmp/Lof0711_ind.GATK_no_dam.unlink.beagle.gz.gzi >tmp/Lof0711_ind.GATK_no_dam.unlink.beagle.gz
...
zcat tmp/Lof0714_ind.GATK_no_dam.beagle.gz | java -jar scripts/filterlines.jar 1 tmp/Lof.gatk.unlink.beagle.pos | bgzip -i -I tmp/Lof0714_ind.GATK_no_dam.unlink.beagle.gz.gzi >tmp/Lof0714_ind.GATK_no_dam.unlink.beagle.gz
...
zcat tmp/Lof1114_ind.GATK_no_dam.beagle.gz | java -jar scripts/filterlines.jar 1 tmp/Lof.gatk.unlink.beagle.pos | bgzip -i -I tmp/Lof1114_ind.GATK_no_dam.unlink.beagle.gz.gzi >tmp/Lof1114_ind.GATK_no_dam.unlink.beagle.gz
...
pcangsd.py -beagle tmp/Lof0711_ind.GATK_no_dam.beagle.gz -selection -minMaf 0.05 -threads 2 -o analysis/pcangsd_lof0711_gatk_no_dam -sites_save
...
pcangsd.py -beagle tmp/Lof0711_ind.GATK_no_dam.unlink.beagle.gz -selection -minMaf 0.05 -threads 2 -o analysis/pcangsd_lof0711_gatk_no_dam_unlink -sites_save
...
pcangsd.py -beagle tmp/Lof0714_ind.GATK_no_dam.beagle.gz -selection -minMaf 0.05 -threads 2 -o analysis/pcangsd_lof0714_gatk_no_dam -sites_save
...
pcangsd.py -beagle tmp/Lof0714_ind.GATK_no_dam.unlink.beagle.gz -selection -minMaf 0.05 -threads 2 -o analysis/pcangsd_lof0714_gatk_no_dam_unlink -sites_save
...
pcangsd.py -beagle tmp/Lof1114_ind.GATK_no_dam.beagle.gz -selection -minMaf 0.05 -threads 2 -o analysis/pcangsd_lof1114_gatk_no_dam -sites_save
...
pcangsd.py -beagle tmp/Lof1114_ind.GATK_no_dam.unlink.beagle.gz -selection -minMaf 0.05 -threads 2 -o analysis/pcangsd_lof1114_gatk_no_dam_unlink -sites_save
...
####################################
rm tmp/*.GATK.beagle.gz tmp/*.GATK.beagle.gz.gzi tmp/*.GATK_no_dam.beagle.gz tmp/*.GATK_no_dam.beagle.gz.gzi tmp/*.GATK_ex_inv.beagle.gz tmp/*.GATK_ex_inv.beagle.gz.gzi tmp/*.GATK.unlink.beagle.gz tmp/*.GATK.unlink.beagle.gz.gzi tmp/*.GATK_no_dam.unlink.beagle.gz tmp/*.GATK_no_dam.unlink.beagle.gz.gzi tmp/*.GATK_ex_inv.unlink.beagle.gz tmp/*.GATK_ex_inv.unlink.beagle.gz.gzi tmp/Can.gatk.unlink.beagle.pos tmp/Lof.gatk.unlink.beagle.pos