...
# outfile <- 'analysis/LOF_07_to_LOF_S_11_to_LOF_S_14_woutInv.wfabc' # w/out inversions
gens =c(0,11,11) # for 1907 vs. 2011 vs. 2014


# read in data
datNEA14 <- fread('data_2019_03_18/Frequency_table_Lof07_Lof14.txt', header=TRUE) # 25kmer and individual read depth filter not applied
	setnames(datNEA14, 3:7, c('N_CHR_07', 'Freq_07', 'N_CHR_14', 'Freq_14', 'ABS_DIFF0714'))
datNEA11 <- fread('data_2019_03_18/Frequency_table_Lof07_Lof11.txt', header=TRUE)
...
# trim out Unplaced
datNEA14 <- datNEA14[!(CHROM %in% c('Unplaced')),]
...
# trim out inversions
if(outfile=='analysis/LOF_07_to_LOF_S_11_to_LOF_S_14_woutInv.wfabc'){
	datNEA14 <- datNEA14[!(CHROM %in% c('LG01', 'LG02', 'LG07', 'LG12')),]
...
# merge
setkey(datNEA14, CHROM, POS, N_CHR_07, Freq_07)
setkey(datNEA11, CHROM, POS, N_CHR_07, Freq_07)
dat <- datNEA14[datNEA11, .(CHROM, POS, N_CHR_07, N_CHR_11, N_CHR_14, Freq_07, Freq_11, Freq_14)]
	dim(dat)
	dim(datNEA14)
	dim(datNEA11)
