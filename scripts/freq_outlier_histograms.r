...
# pdf(width=6, height=4, file='analysis/figures/abs_diff_hist_25k&150k.pdf')
par(mfrow=c(1,2), las=1, cex.axis=0.8, tcl=-0.2, mgp=c(2.5,0.5, 0), mai=c(0.7, 0.7, 0.2, 0.1))
...
legend('topright', legend=c('25 kmer', '150 kmer'), lwd=1, pch=1, col=cols[1:2], cex=0.5)
